...
public class CatalogoLivros {
    ...
    public static void main(String[] args) {
        ...
        catalogoLivros.adicionarLivro("Livro 2", "Autor 3", 2001);
        catalogoLivros.adicionarLivro("Livro 3", "Autor 4", 2002);
        catalogoLivros.adicionarLivro("Livro 4", "Autor 2", 2003);
